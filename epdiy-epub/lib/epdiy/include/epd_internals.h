...
#if defined(EPD_DISPLAY_TYPE_ED097OC4) ||                               \
    defined(EPD_DISPLAY_TYPE_ED097TC2) ||                               \
    defined(EPD_DISPLAY_TYPE_ED097OC4_LQ)
/// Width of the display area in pixels.
#define EPD_WIDTH 1200
/// Height of the display area in pixels.
#define EPD_HEIGHT 825
#elif defined(EPD_DISPLAY_TYPE_ED133UT2)
#define EPD_WIDTH 1600
#define EPD_HEIGHT 1200
#elif defined(EPD_DISPLAY_TYPE_ED060SC4)
/// Width of the display area in pixels.
#define EPD_WIDTH 800
/// Height of the display area in pixels.
#define EPD_HEIGHT 600
#elif defined(EPD_DISPLAY_TYPE_ED060SCT)
/// Width of the display area in pixels.
#define EPD_WIDTH 800
/// Height of the display area in pixels.
#define EPD_HEIGHT 600
#elif defined(EPD_DISPLAY_TYPE_ED060XC3)
/// Width of the display area in pixels.
#define EPD_WIDTH 1024
/// Height of the display area in pixels.
#define EPD_HEIGHT 758
#elif defined(EPD_DISPLAY_TYPE_ED047TC2)
/// Width of the display area in pixels.
...
#if defined(EPD_DISPLAY_TYPE_ED047TC2)
...
#elif defined(EPD_DISPLAY_TYPE_ED097OC4) || defined(EPD_DISPLAY_TYPE_ED097OC4_LQ)
#define EPD_BUILTIN_WAVEFORM &epdiy_ED097OC4
#elif defined(EPD_DISPLAY_TYPE_ED097TC2)
